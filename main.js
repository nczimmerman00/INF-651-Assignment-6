...
const actors = [
  ...
  function introduceTheActors(actorArray) {
        ...
        for (let i = 0; i < actorArray.length; i++) {
            introductionArray[i] = "Hi, I'm " + actorArray[i].name + 
            " and I was in " + actorArray[i].movie + ".";
        }
...
const techCompanies = {
  ...
  function storeFounders(obj){
      let returnArr = Object.values(obj);
      returnArr.pop();
      return returnArr;
  }
  ...
  let blueBerryPie = new Object(pie);
